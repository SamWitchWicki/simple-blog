...
@section('container')
    <h1 class="mb-3" class="text-center">{{ $title }}</h1>
    ...
    <div class="card mb-3">
        @if ($posts[0]->image)
            <div style="max-height: 400px; overflow: hidden;">
                <img src="{{ asset('storage/' . $posts[0]->image) }}" class="img-fluid mb-3 mt-3" alt="{{ $posts[0]->category->name }}">
            </div>
        @else
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-sm-3">
                <div class="card">
                    ...
                    @if ($post->image)
                        <img src="{{ asset('storage/' . $post->image) }}" class="img-fluid mb-3 mt-3" alt="{{ $post->image->category->name }}">
                    @else
